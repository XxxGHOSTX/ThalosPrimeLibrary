...
async def api_status() -> dict[str, Any]:
    ...
    return {
        ...
        "endpoints": {
            ...
            "chat_benchmark_tasks": "/api/v1/chat/benchmark/tasks",
            "chat_benchmark_run": "/api/v1/chat/benchmark/run?task_id=latent-11&seed=2026&perturbation=0",
            "chat_benchmark_compare": "/api/v1/chat/benchmark/compare?seed=2026&perturbation=0",
