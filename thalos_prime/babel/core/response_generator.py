...
class GeneratedResponse:
    ...
    def semantic_core(self) -> SemanticCore:
        """Return the semantic core from the response frame."""
...
class ResponseGenerator:
    ...
    def __init__(
        ...
        """Store injected data-plane subsystems."""
    ...
    def generate(
        ...
        """Generate a deterministic response for user_input at the given coordinate."""
