...
class Inconsistency:
    """Record of a detected state inconsistency."""
...
class Reconciler:
    ...
    def check_state(self, state_last_coordinate: str | None) -> list[Inconsistency]:
        """Inspect last coordinate for format violations; return detected issues."""
    ...
    def resolve(self, inconsistencies: list[Inconsistency]) -> None:
        """Raise RuntimeError for any critical inconsistencies; log non-critical ones."""
