...
class FrameType(Enum):
    """Enumeration of semantic frame categories for response generation."""
...
class SemanticFrame:
    ...
    def to_variables(self) -> dict[str, str]:
        """Return the slot-variable mapping for template interpolation."""
...
class FrameConstructor:
    ...
    def __init__(self, classifier: DeterministicIntentClassifier) -> None:
        """Initialize with *classifier* for intent-driven frame selection."""
        self.classifier = classifier

    def construct(self, user_input: str) -> SemanticFrame:
        """Build a SemanticFrame from *user_input* using intent classification."""
