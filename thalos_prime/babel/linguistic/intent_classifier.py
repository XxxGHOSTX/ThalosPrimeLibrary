...
class Intent(Enum):
    """Enumeration of supported user intent categories."""
...
class IntentAnalysis:
    """Result of classifying a single user utterance."""
...
class DeterministicIntentClassifier:
    ...
    def classify(self, user_input: str) -> IntentAnalysis:
        """Classify *user_input* and return an IntentAnalysis with topic fingerprint."""
