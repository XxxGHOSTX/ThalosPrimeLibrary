...
Thank you for your interest in contributing to Thalos Prime Library! This document outlines the
development workflow, requirements, and enforcement criteria.
...
participating, you are expected to uphold this code. Please report unacceptable behavior via the
repository's [Security advisories](https://github.com/XxxGHOSTX/ThalosPrimeLibrary/security/advisories/new).
